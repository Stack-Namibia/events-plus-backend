...
import { AuthorizeUserModel } from '@/http/nodegen/interfaces/AuthorizeUserModel';
import { RegisterUserPost } from '@/http/nodegen/interfaces/RegisterUserPost';

class RegisterDomainMock {
...
export default new RegisterDomainMock();
